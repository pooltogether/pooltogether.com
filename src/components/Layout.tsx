...
export const Layout = (props: LayoutProps) => {
  ...
  const { setIsModalOpen: setIsCaptchaModalOpen } = useIsModalOpen(
    MODAL_KEYS.captcha
  );
  ...
  const footerItems: FooterItem[] = [
    ...
    },
    {
      ...
      content: [
        ...
        {
          content: "Protocol Disclaimer",
          href: LINKS.protocolDisclaimer,
        },
        { content: "Terns of Service", href: LINKS.termsOfService },
      ],
    },
    {
      ...
      content: [
        {
          ...
          href: LINKS.twitter,
          icon: (
            <SocialIcon platform="twitter" className="w-6 h-auto shrink-0" />
          ),
        },
        {
          content: "Discord",
          ...
          icon: (
            <SocialIcon platform="discord" className="w-6 h-auto shrink-0" />
          ),
        },
        {
          content: "GitHub",
          href: LINKS.github,
          icon: (
            <SocialIcon platform="github" className="w-6 h-auto shrink-0" />
          ),
        },
        {
          content: "Medium",
          href: LINKS.medium,
          icon: (
            <SocialIcon platform="medium" className="w-6 h-auto shrink-0" />
          ),
        },
      ],
    },
  ...
  const isDarkerFooterBg =
    router.pathname === "/" || router.pathname === "/ecosystem";
      ...
      <Navbar
        ...
        append={
          <Button href={LINKS.app_v4}>
            <span className="text-sm md:px-5 md:text-base">
              {t_nav("usePt")}
            </span>
          </Button>
        }
