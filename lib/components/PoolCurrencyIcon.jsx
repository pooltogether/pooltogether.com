...
import DaiSvg from 'public/images/dai-new-transparent.png'
import WbtcSvg from 'public/images/asset_BTC.svg'
import MissingCurrencySvg from 'public/images/activity.svg'
import UsdcSvg from 'public/images/usdc-new-transparent.png'
import UsdtSvg from 'public/images/usdt-new-transparent.png'

export const PoolCurrencyIcon = (props) => {
  const { className, sm, lg, xl, pool } = props
