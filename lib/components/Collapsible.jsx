...
export const Collapsible = class _Collapsible extends Component {
  ...
  render () {
    ...
    return (
      <div
        className={classnames('trans  mx-0 sm:mx-0', {
      ...
      >
        <div
          ...
          className={classnames(
            'flex items-center cursor-pointer collapsible-target px-3 sm:px-6 -mx-3 sm:-mx-6 hover:bg-accent-grey-1 rounded-full pt-1',
            {
        ...
        >
          ...
          >
            <span
              className={classnames('inline-block ml-auto rounded trans', {
                'text-white': this.state.active,
                '': !this.state.active
              })}
            >
              <FeatherIcon
                icon='chevron-up'
                className={classnames('ml-auto trans w-4 h-4 sm:w-8 sm:h-8', {
        ...
        <p
          ...
          // }}
          className={classnames('text-xs sm:text-sm md:text-base', 'my-4', 'collapsible-content', {
